...
- (void)initializeControl {
    ...
    [self.plusButton setImage:[UIImage imageNamed:@"UIStepperPlus.png"] forState:UIControlStateNormal];
    [self.plusButton setImage:[UIImage imageNamed:@"UIStepperPlusPressed.png"] forState:UIControlStateHighlighted];
